      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link href="/" className="text-sm font-medium text-gray-300 hover:text-white transition-colors tracking-wide">Início</Link>
            <Link href="/modelos" className="text-sm font-medium text-gray-300 hover:text-white transition-colors tracking-wide">Modelos</Link>
            <Link href="/#about" className="text-sm font-medium text-gray-300 hover:text-white transition-colors tracking-wide">Sobre</Link>
            <Link href="/contato" className="text-sm font-medium text-gray-300 hover:text-white transition-colors tracking-wide">Contato</Link>
          </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-4">
              <Link href="/" onClick={() => setMobileMenuOpen(false)} className="text-gray-300 hover:text-white py-2 text-lg">Início</Link>
              <Link href="/modelos" onClick={() => setMobileMenuOpen(false)} className="text-gray-300 hover:text-white py-2 text-lg">Modelos</Link>
              <Link href="/#about" onClick={() => setMobileMenuOpen(false)} className="text-gray-300 hover:text-white py-2 text-lg">Sobre</Link>
              <Link href="/contato" onClick={() => setMobileMenuOpen(false)} className="text-gray-300 hover:text-white py-2 text-lg">Contato</Link>
